---
title: '[코딩 테스트 풀이 - 2] 프로그래머스 42888 — 오픈채팅방'
description: 'PROGRAMERS 42888 해설'
date: 2020-08-21
category: DEV
postType: journal
cover: '/images/categories/development.jpg'
coverAlt: '프로그래머스 42888 오픈채팅방 풀이'
featured: false
tags: [코딩-테스트-풀이, 프로그래머스, 해시, 문자열, C-plus-plus]
---
...
**LINK** : [PROGRAMMERS 오픈채팅방](https://programmers.co.kr/learn/courses/30/lessons/42888)
